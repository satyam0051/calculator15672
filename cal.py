...
if __name__ == "__main__": 
	...
	button1 = Button(gui, text=' 1 ', fg='black', bg='white', 
					command=lambda: press(1), height=1, width=8).grid(row=3, column=0) 
	...
	squre=Button(gui,text="^",fg='black',bg='white',command=lambda: press('**'),height=1,width=8)
	
	squre.grid(row=7,column=2)

	coma=Button(gui,text=',',fg='black',bg='white',command=lambda: press(','),height=1,width=8)

	coma.grid(row=7,column=1)

	per=Button(gui,text='%',fg="black",bg='white',command=lambda: press('%'),height=1,width=8)

	per.grid(row=6,column=1)

	root=Button(gui,text=u"\u221A",fg="black",bg="white",command=root,height=1,width=8).grid(row=8,column=0)
	
	fact=Button(gui,text='!',fg='black',bg='white',command=lambda :press('!'),height=1,width=8).grid(row=8,column=1)
	bracket=Button(gui,text='(',fg='black',bg='white',command=lambda: press('('),height=1,width=8).grid(row=8,column=2)
	bracket1=Button(gui,text=')',fg='black',bg='white',command=lambda: press(')'),height=1,width=8).grid(row=8,column=3)
